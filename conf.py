...
BLOG_AUTHOR = "Greg Stencel"  # (translatable)
BLOG_TITLE = "Greg's Tech Notes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://stencel.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://stencel.io/"
BLOG_EMAIL = "gstencel@gmail.com"
BLOG_DESCRIPTION = "Tech notes and tips"  # (translatable)
...
#fruity monokai native paraiso-dark
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://www.linkedin.com/in/gregstencel/', 'My Linkedin', 'fab fa-linkedin'),
        ('https://github.com/greg4fun', 'My Github', 'fab fa-github'),
    )
}
BODY_END= """
<script>
